...
const DashboardLayout = ({ children }) => {
    ...
    return (
        <div className="flex gap-5 md:p-5 p-3">
            {/* slider */}
            <div className="flex bg-gray-100 items-center text-center md:p-1 p-3 rounded-xl md:flex-col flex-row gap-4 justify-between fixed md:h-[95%] h-fit md:w-fit w-full z-20 md:left-3 left-0 md:-translate-y-1/2 md:top-1/2 top-0">
