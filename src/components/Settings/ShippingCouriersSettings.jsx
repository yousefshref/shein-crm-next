    ...
    return (
        <div className='flex flex-col'>
            <div className='flex items-center gap-5 justify-between mt-20'>
                ...
                <CreateOrUpdateShippingCourier deleteShippingCourier={deleteShippingCourier} getShippingCouriers={getShippingCouriers} shippingCourier={shippingCourier} open={open} setOpen={setOpen} />
            </div>
